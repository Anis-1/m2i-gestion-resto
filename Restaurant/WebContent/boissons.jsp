			...
			<div class="col-md-9 order-md-1">
				...
				<div class="col">
					<ul class="nav nav-tabs" id="plats">
						...
						<li class="nav-item"><a class="nav-link active" href="boissons.jsp">Boissons</a></li>
					</ul>
					</div>
				</div>
				<article id="article">
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Boisson_1.png" class="pic" alt="Boisson 1"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Boisson 1</h2>
							<p class="description-plat">Description Boisson 1</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Boisson_2.png" class="pic" alt="Boisson 2"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Boisson 2</h2>
							<p class="description-plat">Description Boisson 2</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Boisson_3.png" class="pic" alt="Boisson 3"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Boisson 3</h2>
							<p class="description-plat">Description Boisson 3</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Boisson_4.png" class="pic" alt="Boisson 4"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Boisson 4</h2>
							<p class="description-plat">Description Boisson 4</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Boisson_5.png" class="pic" alt="Boisson 5"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Boisson 5</h2>
							<p class="description-plat">Description Boisson 5</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Boisson_6.png" class="pic" alt="Boisson 6"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Boisson 6</h2>
							<p class="description-plat">Description Boisson 6</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Boisson_7.png" class="pic" alt="Boisson 7"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Boisson 7</h2>
							<p class="description-plat">Description Boisson 7</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Boisson_8.png" class="pic" alt="Boisson 8"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Boisson 8</h2>
							<p class="description-plat">Description Boisson 8</p>
						</div>
