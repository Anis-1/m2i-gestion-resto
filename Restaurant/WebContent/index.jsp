...
<body>
	...
	<div class="container">
		...
		<div id="carouselExampleIndicators" class="carousel"
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="Images/Resto_1.png" class="d-block w-100" height="400"
						alt="Image_1">
				</div>
				<div class="carousel-item">
					<img src="Images/Resto_2.png" class="d-block w-100" height="400"
						alt="Image_2">
				</div>
				<div class="carousel-item">
					<img src="Images/Resto_3.png" class="d-block w-100" height="400"
						alt="Image_3">
				</div>
				<div class="carousel-item">
					<img src="Images/Resto_4.png" class="d-block w-100" height="400"
						alt="Image_4">
				</div>
			</div>
		...
		<section id="contains" class="row">
			<aside class="col-md-3 col order-md-12">
					...
					<div class="col">
						<ul class="nav nav-tabs " id="plats">
							<li class="nav-item"><a class="nav-link active"
								href="index.jsp">Suggestion du jour</a></li>
				...
				<article id="article">
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Entree_5.png" class="pic"
								alt="Suggestion Entree" width="100%" />
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/entrecote.png" class="pic"
								alt="Suggestion Plat Avec Viande" width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Viande 3</h2>
							<p class="description-plat">Description Viande 3</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Poisson_7.png" class="pic"
								alt="Suggestion Plat Sans Viande" width="100%" />
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Dessert_2.png" class="pic"
								alt="Suggestion Dessert" width="100%" />
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Boisson_8.png" class="pic"
								alt="Suggestion Boisson" width="100%" />
						</div>
