			...
			<div class="col-md-9 order-md-1">
				...
				<div class="col">
					<ul class="nav nav-tabs" id="plats">
						...
						<li class="nav-item"><a class="nav-link active" href="desserts.jsp">Desserts</a></li>
				...
				<article id="article">
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Dessert_1.png" class="pic" alt="Dessert 1"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Dessert 1</h2>
							<p class="description-plat">Description Dessert 1</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Dessert_2.png" class="pic" alt="Dessert 2"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Dessert 2</h2>
							<p class="description-plat">Description Dessert 2</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Dessert_3.png" class="pic" alt="Dessert 3"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Dessert 3</h2>
							<p class="description-plat">Description Dessert 3</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Dessert_4.png" class="pic" alt="Dessert 4"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Dessert 4</h2>
							<p class="description-plat">Description Dessert 4</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Dessert_5.png" class="pic" alt="Dessert 5"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Dessert 5</h2>
							<p class="description-plat">Description Dessert 5</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Dessert_6.png" class="pic" alt="Dessert 6"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Dessert 6</h2>
							<p class="description-plat">Description Dessert 6</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Dessert_7.png" class="pic" alt="Dessert 7"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Dessert 7</h2>
							<p class="description-plat">Description Dessert 7</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/Dessert_8.png" class="pic" alt="Dessert 8"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Dessert 8</h2>
							<p class="description-plat">Description Dessert 8</p>
						</div>
