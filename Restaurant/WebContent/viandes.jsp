			...
			<div class="col-md-9 order-md-1">
				...
				<div class="col">
					<ul class="nav nav-tabs" id="plats">
						...
						<li class="nav-item"><a class="nav-link active" href="viandes.jsp">Viandes</a></li>
				...
				<article id="article">
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/entrecote.png" class="pic" alt="Viande 1"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">L'entrecôte</h2>
							<p class="description-plat">Boeuf Français, accompagnement au
								choix (frites, laiture ou pomme de terre au four)</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/burger.png" class="pic" alt="Viande 2"
								width="100%" />
						</div>

						<div class="texte-plat col-sm-8">
							<h2 class="titre-plat">Le Burger du Chef</h2>
							<p class="description-plat">Boeuf 100% Français, Comté AOC, Salade locavore, sauce TOP SECRET)</p>
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/entrecote.png" class="pic" alt="Viande 3"
								width="100%" />
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/burger.png" class="pic" alt="Viande 4"
								width="100%" />
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/entrecote.png" class="pic" alt="Viande 5"
								width="100%" />
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/burger.png" class="pic" alt="Viande 6"
								width="100%" />
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/entrecote.png" class="pic" alt="Viande 7"
								width="100%" />
						</div>
					...
					<div class="menu-element row">
						<div class="illustration col-sm-3">
							<img src="Images/burger.png" class="pic" alt="Viande 8"
								width="100%" />
						</div>
