...
<body>
	...
	<div id="tabs">
		<ul class="nav nav-tabs" id="plats">
			<li class="nav-item"><a class="nav-link" href="#">Entrées</a></li>
			<li class="nav-item"><a class="nav-link" href="#">Salades</a></li>
			<li class="nav-item"><a class="nav-link active" href="#">Viandes</a>
			</li>
			<li class="nav-item"><a class="nav-link" href="#">Poissons</a></li>
			<li class="nav-item"><a class="nav-link" href="#">Desserts</a></li>
